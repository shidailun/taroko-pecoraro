...
`tools/orthography/build_modern_map.py`, 6,730 tokens of which 4,809 actually
...
- **id** (1,074) — original spelling already attested in the omnibus; left unchanged
...
- **M** (746 of 791 keys) — hand-curated, gloss-verified (`tools/orthography/manual_map.json`).
