...
`tools/orthography/build_modern_map.py`, 6,730 tokens of which 4,816 actually
...
- **id** (1,073) — original spelling already attested in the omnibus; left unchanged
...
- **M** (760 of 805 keys) — hand-curated, gloss-verified (`tools/orthography/manual_map.json`).
