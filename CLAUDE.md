...
`tools/orthography/build_modern_map.py`, 6,733 tokens of which 4,805 actually
...
- **id** (1,085) — original spelling already attested in the omnibus; left unchanged
...
- **M** (773) — hand-curated, gloss-verified (`tools/orthography/manual_map.json`).
