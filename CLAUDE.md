...
`tools/orthography/build_modern_map.py`, 6,730 tokens of which 4,836 actually
...
- **id** (1,069) — original spelling already attested in the omnibus; left unchanged
...
- **M** (822 of 866 keys) — hand-curated, gloss-verified (`tools/orthography/manual_map.json`).
