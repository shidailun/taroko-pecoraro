...
`tools/orthography/build_modern_map.py`, 6,733 tokens of which 4,791 actually
...
- **M** (739) — hand-curated, gloss-verified (`tools/orthography/manual_map.json`).
...
- **W** (301) — the written schwa before a word-initial labial. A post-pass, run after
  ...
  **`class`** (160, batch 27) takes it where nothing witnesses either form but the
