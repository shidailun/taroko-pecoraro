...
`tools/orthography/build_modern_map.py`, 6,719 tokens of which 4,681 actually
...
- **id** (1,090) — original spelling already attested in the omnibus; left unchanged
...
- **M** (661) — hand-curated, gloss-verified (`tools/orthography/manual_map.json`).
