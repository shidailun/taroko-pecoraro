...
`tools/orthography/build_modern_map.py`, 6,730 tokens of which 4,805 actually
...
- **id** (1,075) — original spelling already attested in the omnibus; left unchanged
...
- **M** (735 of 780 keys) — hand-curated, gloss-verified (`tools/orthography/manual_map.json`).
