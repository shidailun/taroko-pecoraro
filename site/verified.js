...
// The modern spellings a modern source vouches for: 5305 of the 6567 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (4127). 2 = the wordlist does not list it, but it is a
// regular inflection of a root the wordlist does list, and that root means
// what he says the word means (849) — a listing gap, not a lexical one.
// 3 = the wordlist does not list it BARE, but it lists two or more of its
// own inflections and one of them means what he says it means (66) — a
...
// GLOSSED, spoken for by that root's own paradigm (56). Rule 2 asks two
...
// for through ITS own inflections (126). Neither the word nor its root is
...
// paradigm suffixes and not with this one (26). Most of a paradigm is
...
// 7 = 2 with the root's OWN first vowel syncopated (40). Truku writes no
...
// 8 = 2 over a root that is itself one step from a glossed root (9):
...
// 9 = an AFFIX LETTER (6). Twelve of his cards are headed by one letter
