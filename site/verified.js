...
// The modern spellings a modern source vouches for: 5174 of the 6569 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (4038). 2 = the wordlist does not list it, but it is a
...
// for through ITS own inflections (152). Neither the word nor its root is
...
// paradigm suffixes and not with this one (31). Most of a paradigm is
...
// 6 = 2 with the root's OWN first vowel syncopated (41). Truku writes no
...
// 7 = 2 over a root that is itself one step from a glossed root (10):
...
// 8 = an AFFIX LETTER (6). Twelve of his cards are headed by one letter
