...
// The modern spellings a modern source vouches for: 5650 of the 6544 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (4181). 2 = the wordlist does not list it, but it is a
// regular inflection of a root the wordlist does list, and that root means
// what he says the word means (974) — a listing gap, not a lexical one.
...
// two of the root's own inflections (75). Rule 4 asks the paradigm where
...
// never glossed (116). Rule 2 makes his Chinese and the root's gloss agree
...
// for through ITS own inflections (100). Neither the word nor its root is
...
// paradigm suffixes and not with this one (14). Most of a paradigm is
...
// 9 = 2 with the root's OWN first vowel syncopated (33). Truku writes no
