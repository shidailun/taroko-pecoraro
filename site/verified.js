...
// The modern spellings a modern source vouches for: 5598 of the 6567 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (4164). 2 = the wordlist does not list it, but it is a
// regular inflection of a root the wordlist does list, and that root means
// what he says the word means (971) — a listing gap, not a lexical one.
// 3 = the wordlist does not list it BARE, but it lists two or more of its
// own inflections and one of them means what he says it means (76) — a
...
// GLOSSED, spoken for by that root's own paradigm (53). Rule 2 asks two
...
// two of the root's own inflections (46). Rule 4 asks the paradigm where
...
// never glossed (117). Rule 2 makes his Chinese and the root's gloss agree
...
// for through ITS own inflections (105). Neither the word nor its root is
...
// 9 = 2 with the root's OWN first vowel syncopated (38). Truku writes no
