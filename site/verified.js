...
// The modern spellings a modern source vouches for: 6128 of the 6522 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (4473). 2 = the wordlist does not list it, but it is a
// regular inflection of a root the wordlist does list, and that root means
// what he says the word means (1067) — a listing gap, not a lexical one.
// 3 = the wordlist does not list it BARE, but it lists two or more of its
// own inflections and one of them means what he says it means (81) — a
...
// never glossed (183). Rule 2 makes his Chinese and the root's gloss agree
...
// for through ITS own inflections (89). Neither the word nor its root is
...
// paradigm suffixes and not with this one (11). Most of a paradigm is
...
// 13 = an AFFIX LETTER (5). Twelve of his cards are headed by one letter
...
// 16 = SETTLED BY CLASS (262), and the only code here that is not a rung
