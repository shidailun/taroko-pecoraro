...
// The modern spellings a modern source vouches for: 5036 of the 6570 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (3906). 2 = the wordlist does not list it, but it is a
// regular inflection of a root the wordlist does list, and that root means
// what he says the word means (836) — a listing gap, not a lexical one.
// 3 = the wordlist does not list it BARE, but it lists two or more of its
// own inflections and one of them means what he says it means (59) — a
...
// for through ITS own inflections (149). Neither the word nor its root is
...
// paradigm suffixes and not with this one (38). Most of a paradigm is
...
// 6 = 2 with the root's OWN first vowel syncopated (38). Truku writes no
