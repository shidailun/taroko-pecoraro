...
// The modern spellings a modern source vouches for: 5915 of the 6526 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (4295). 2 = the wordlist does not list it, but it is a
// regular inflection of a root the wordlist does list, and that root means
// what he says the word means (1035) — a listing gap, not a lexical one.
...
// GLOSSED, spoken for by that root's own paradigm (63). Rule 2 asks two
...
// two of the root's own inflections (81). Rule 4 asks the paradigm where
...
// never glossed (193). Rule 2 makes his Chinese and the root's gloss agree
...
// paradigm suffixes and not with this one (12). Most of a paradigm is
...
// 9 = 2 with the root's OWN first vowel syncopated (35). Truku writes no
