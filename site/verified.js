...
// The modern spellings a modern source vouches for: 5770 of the 6540 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (4192). 2 = the wordlist does not list it, but it is a
// regular inflection of a root the wordlist does list, and that root means
// what he says the word means (986) — a listing gap, not a lexical one.
// 3 = the wordlist does not list it BARE, but it lists two or more of its
// own inflections and one of them means what he says it means (82) — a
...
// GLOSSED, spoken for by that root's own paradigm (61). Rule 2 asks two
...
// two of the root's own inflections (90). Rule 4 asks the paradigm where
...
// never glossed (195). Rule 2 makes his Chinese and the root's gloss agree
...
// 9 = 2 with the root's OWN first vowel syncopated (32). Truku writes no
...
// pale.
// 14 = HE NAMES THE WORD (5). Some glosses are not meanings but
