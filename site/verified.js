...
// The modern spellings a modern source vouches for: 5455 of the 6567 distinct
...
// own inflections and one of them means what he says it means (71) — a
...
// GLOSSED, spoken for by that root's own paradigm (55). Rule 2 asks two
...
// never glossed (128). Rule 2 makes his Chinese and the root's gloss agree
...
// for through ITS own inflections (123). Neither the word nor its root is
...
// paradigm suffixes and not with this one (25). Most of a paradigm is
...
// 8 = 2 with the root's OWN first vowel syncopated (38). Truku writes no
...
// 10 = an AFFIX LETTER (5). Twelve of his cards are headed by one letter
