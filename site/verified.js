...
// The modern spellings a modern source vouches for: 5768 of the 6544 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (4194). 2 = the wordlist does not list it, but it is a
...
// 10 = 2 over a root that is itself one step from a glossed root (9):
...
// 11 = an AFFIX LETTER (5). Twelve of his cards are headed by one letter
...
// 12 = HIS OWN PARADIGM, where the wordlist has none (6). Rule 4 asks a
...
// pale.
// 13 = HE NAMES THE WORD (5). Some glosses are not meanings but
