...
// The modern spellings a modern source vouches for: 5932 of the 6526 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (4299). 2 = the wordlist does not list it, but it is a
...
// derivatives refute.
// 11 = 2 over a root that is itself one step from a glossed root (9):
...
// 12 = an AFFIX LETTER (5). Twelve of his cards are headed by one letter
...
// 13 = HIS OWN PARADIGM, where the wordlist has none (6). Rule 4 asks a
...
// pale.
// 14 = HE NAMES THE WORD (6). Some glosses are not meanings but
