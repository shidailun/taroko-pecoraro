...
// The modern spellings a modern source vouches for: 5924 of the 6526 distinct
// values the curated tables can put on screen. 1 = a modern source lists
// this exact word (4296). 2 = the wordlist does not list it, but it is a
// regular inflection of a root the wordlist does list, and that root means
// what he says the word means (1064) — a listing gap, not a lexical one.
...
// 9 = 2 with the root's OWN first vowel syncopated (37). Truku writes no
