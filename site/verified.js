...
// The modern spellings a modern source vouches for: 5002 of the 6570 distinct
...
// what he says the word means (822) — a listing gap, not a lexical one.
// 3 = the wordlist does not list it BARE, but it lists two or more of its
// own inflections and one of them means what he says it means (58) — a
...
// for through ITS own inflections (132). Neither the word nor its root is
...
// paradigm suffixes and not with this one (35). Most of a paradigm is
...
// 7 = 2 over a root that is itself one step from a glossed root (11):
