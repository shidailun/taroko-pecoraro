...
var WORD_OVERRIDES = {
  ...
  document.getElementById("btn-about").addEventListener("click", function () {
    ...
    openSheet(
      ...
      "<p>Pecoraro's own 1977 spelling is what the book prints and what this edition stores; a modern spelling can be switched on under ⚙, word by word rather than by rule. It is shown in three shades so you can see how far it is a claim and how far a proposal: <b style=\"color:var(--accent)\">dark brown</b> where a modern Truku source has the word, or has a root the word is a regular inflection of; <b style=\"color:var(--accent-deep)\">a deeper brown</b> where no wordlist can settle the word either way — a personal name, an onomatopoeion or a Japanese loan, which its class settles instead; and <b style=\"color:var(--accent-weak)\">pale brown</b> where neither is true and the spelling is only our best reading. <b>99.3% of the words on screen are in the brown.</b></p>" +
      "<p>本書所印、本版所存者為貝科拉羅神父1977年之原文拼寫；現代拼寫可於 ⚙ 開啟，逐詞比對而非套用通則。現代拼寫以三色標示，以區別確證與推測：<b style=\"color:var(--accent)\">深棕色</b>表示現代太魯閣語文獻確有此詞，或此詞為文獻所收詞根的規則變化形；<b style=\"color:var(--accent-deep)\">更深棕色</b>表示辭書無從判定之詞——人名、擬聲詞與日語借詞，依其類別判定；<b style=\"color:var(--accent-weak)\">淺棕色</b>表示兩者皆無，僅為本辭典之判讀。<b>螢幕上 99.3% 的詞屬棕色。</b></p>" +
