# -*- coding: utf-8 -*-
"""Batch 225 baseline: the DOM before anything is written."""
...
WATCH = ["kubuy", "kbui", "knubuy", "kbuyu", "knbuyu", "pkbuyu", "buyu", "kbuyun"]
...
json.dump(d, io.open(".scratch/b225/after.json", "w", encoding="utf-8"))
