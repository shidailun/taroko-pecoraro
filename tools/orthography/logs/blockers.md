...
290 pairs are blocked by exactly one type; 20 by two or more and are not credited to any single word.

| class | types | pairs |
|---|---|---|
| gloss disagrees | 7 | 9 |
| no root | 201 | 236 |
| root unglossed | 32 | 32 |
...
## root unglossed — 32 types, 32 pairs
